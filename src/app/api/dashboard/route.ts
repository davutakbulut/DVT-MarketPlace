...
export async function GET(request: Request) {
  try {
    ...
    // 1. Overall Aggregation & 14 Masraf Kalemleri
    ...
    const gross = parseFloat(agg.gross_amount) || 0;
    const paid = parseFloat(agg.paid_amount) || gross;
    ...
    // 2. Daily Profit Performance Trends
    ...
    // 4. Carrier distribution for Selected Period
    ...
    // 5. Hourly Order Distribution (Heatmap 0-23 hours)
    ...
    // 6. Top profitable products for Selected Period
    ...
    // 7. Recent orders for Selected Period
