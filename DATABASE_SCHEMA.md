# 🗄️ DVT-MarketPlace: Veritabanı Şeması ve SQL DDL Kılavuzu (DATABASE_SCHEMA.md)

## 1. Veritabanı Özeti & Bağlantı Bilgileri
- **Veritabanı Motoru**: Supabase PostgreSQL 15
- **Proje Adı**: `DVT-MarketPlace`
- **Project Ref**: `dzgfhmsfvbwsxdddxxhb`
- **Supabase URL**: `https://dzgfhmsfvbwsxdddxxhb.supabase.co`
- **Connection Pooler (Supavisor)**: `postgresql://postgres:[PASSWORD]@db.dzgfhmsfvbwsxdddxxhb.supabase.co:6543/postgres?pgbouncer=true&sslmode=require`
- **Direct Port (DDL & Migrations)**: `postgresql://postgres:[PASSWORD]@db.dzgfhmsfvbwsxdddxxhb.supabase.co:5432/postgres?sslmode=require`

---

## 2. İlişkisel Şema Tasarımı & Tablolar (DDL)
